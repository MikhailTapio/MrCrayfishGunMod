...
public abstract class Attachment
{
    ...
    public static void addInformationEvent(ItemTooltipEvent event)
    {
        ...
        if(stack.getItem() instanceof IAttachment<?>)
        {
            ...
            {
                addPerk(positivePerks, true, "perk.cgm.additional_damage.positive", net.minecraft.world.item.component.ItemAttributeModifiers.ATTRIBUTE_MODIFIER_FORMAT.format(additionalDamage / 2.0));
            }
            else if(additionalDamage < 0.0F)
            {
                addPerk(negativePerks, false, "perk.cgm.additional_damage.negative", net.minecraft.world.item.component.ItemAttributeModifiers.ATTRIBUTE_MODIFIER_FORMAT.format(additionalDamage / 2.0));
            }
